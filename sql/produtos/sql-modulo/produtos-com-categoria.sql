...
`desc_[SUFIXO]` TEXT NOT NULL COMMENT 'Descri̤̣o' ,                                `preco_[SUFIXO]` decimal(10,2) DEFAULT NULL COMMENT 'Pre̤o',
...
INSERT INTO `modulos` (`nome_interno_modulo`, `nome_plural_modulo`, `nome_singular_modulo`, `caracter_modulo`, `nome_tabela_modulo`, `sufix_tabela_modulo`, `nome_principal_menu`, `campos_exibir_modulo`, `sql_listagem_personalizado`, `campos_nao_aparecer_formulario`) VALUES ('[NOME_INTERNO]', 'Categorias', 'Categoria', '[CARACTER_MODULO]', '[NOME_TBL]cat', 'cat', '[NOME_PLURAL]','nome_cat','{"campos":"id_cat, nome_cat","joins":"","order":"nome_cat ASC","where":""}', 'pai_cat');
...
UPDATE  `config_site` SET  `[NOME_TBL]cat_qtd_niveis` = '1' WHERE `id_config` = 1;
